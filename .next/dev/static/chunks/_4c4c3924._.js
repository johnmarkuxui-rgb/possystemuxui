...
function AdminUsersPage() {
    ...
    if ($[0] !== "53a5fbf2866c597f0f9fc761436968379d8ede99bea424ff55116a6bb14c3d83") {
        for(let $i = 0; $i < 72; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "53a5fbf2866c597f0f9fc761436968379d8ede99bea424ff55116a6bb14c3d83";
    }
    const { user: currentUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    const { users, addUser, removeUser, getUsersByTenant } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useUserStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"])();
    let t0;
    ...
    const [usersList, setUsersList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    ...
    let t2;
    if ($[3] !== currentUser?.tenantId || $[4] !== getUsersByTenant) {
        t2 = ({
        ...
        $[3] = currentUser?.tenantId;
        $[4] = getUsersByTenant;
        $[5] = t2;
    } else {
        t2 = $[5];
    }
    const t3 = currentUser?.tenantId;
    let t4;
    if ($[6] !== getUsersByTenant || $[7] !== t3 || $[8] !== users) {
        t4 = [
            t3,
            users,
            getUsersByTenant
    ...
    let t5;
    if ($[10] !== addUser || $[11] !== currentUser || $[12] !== formData.confirmPassword || $[13] !== formData.email || $[14] !== formData.name || $[15] !== formData.password || $[16] !== formData.role || $[17] !== formData.username || $[18] !== users) {
        t5 = ({
            "AdminUsersPage[handleSubmit]": (e)=>{
                e.preventDefault();
                setError("");
                setSuccess("");
                ...
                if (users.some({
                    "AdminUsersPage[handleSubmit > users.some()]": (u)=>u.username === formData.username
                }["AdminUsersPage[handleSubmit > users.some()]"])) {
                    setError("Username already exists");
                    return;
                }
                setIsLoading(true);
                setTimeout({
                    "AdminUsersPage[handleSubmit > setTimeout()]": ()=>{
                        addUser({
                ...
                }["AdminUsersPage[handleSubmit > setTimeout()]"], 1000);
            }
        })["AdminUsersPage[handleSubmit]"];
        $[10] = addUser;
        $[11] = currentUser;
        $[12] = formData.confirmPassword;
        $[13] = formData.email;
        $[14] = formData.name;
        $[15] = formData.password;
        $[16] = formData.role;
        $[17] = formData.username;
        $[18] = users;
        $[19] = t5;
    } else {
        t5 = $[19];
        ...
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Manage staff accounts and access permissions for your branch"
                }, void 0, false, {
                    fileName: "[project]/src/app/admin/users/page.tsx",
                    lineNumber: 168,
                    columnNumber: 106
    ...
    let t8;
    if ($[22] !== error) {
        t8 = error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            initial: {
                opacity: 0,
                y: -10
            },
    ...
    if ($[29] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t13 = ({
            "AdminUsersPage[<motion.button>.onClick]": ()=>setShowAddModal(true)
        })["AdminUsersPage[<motion.button>.onClick]"];
        $[29] = t11;
        $[30] = t12;
        $[31] = t13;
    } else {
    ...
    const t16 = currentUser?.tenantId;
    let t17;
    if ($[34] !== t16) {
    ...
    let t19;
    if ($[37] !== currentUser?.id || $[38] !== removeUser || $[39] !== usersList) {
        let t20;
        if ($[41] !== currentUser?.id || $[42] !== removeUser) {
            t20 = ({
                "AdminUsersPage[usersList.map()]": (user)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: {
                                        "AdminUsersPage[usersList.map() > <button>.onClick]": ()=>{
    ...
    let t21;
    if ($[46] !== usersList.length) {
        t21 = usersList.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t25;
    if ($[57] !== formData.confirmPassword || $[58] !== formData.email || $[59] !== formData.name || $[60] !== formData.password || $[61] !== formData.role || $[62] !== formData.username || $[63] !== handleSubmit || $[64] !== isLoading || $[65] !== showAddModal) {
        t25 = showAddModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            initial: {
                opacity: 0
            },
            animate: {
            ...
            onClick: {
                "AdminUsersPage[<motion.div>.onClick]": ()=>setShowAddModal(false)
            }["AdminUsersPage[<motion.div>.onClick]"],
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                initial: {
                    scale: 0.95,
                    opacity: 0
                ...
                onClick: _AdminUsersPageMotionDivOnClick,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: {
                                    "AdminUsersPage[<button>.onClick]": ()=>setShowAddModal(false)
                                }["AdminUsersPage[<button>.onClick]"],
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        value: formData.name,
                                        onChange: {
                                            "AdminUsersPage[<input>.onChange]": (e_1)=>setFormData({
                                                    "AdminUsersPage[<input>.onChange > setFormData()]": (prev)=>({
                                                            ...prev,
                                                            name: e_1.target.value
                                                        })
                                                }["AdminUsersPage[<input>.onChange > setFormData()]"])
                                        }["AdminUsersPage[<input>.onChange]"],
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        onChange: {
                                            "AdminUsersPage[<input>.onChange]": (e_2)=>setFormData({
                                                    "AdminUsersPage[<input>.onChange > setFormData()]": (prev_0)=>({
                                                            ...prev_0,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        onChange: {
                                            "AdminUsersPage[<input>.onChange]": (e_3)=>setFormData({
                                                    "AdminUsersPage[<input>.onChange > setFormData()]": (prev_1)=>({
                                                            ...prev_1,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        value: formData.role,
                                        onChange: {
                                            "AdminUsersPage[<select>.onChange]": (e_4)=>setFormData({
                                                    "AdminUsersPage[<select>.onChange > setFormData()]": (prev_2)=>({
                                                            ...prev_2,
                                                            role: e_4.target.value
                                                        })
                                                }["AdminUsersPage[<select>.onChange > setFormData()]"])
                                        }["AdminUsersPage[<select>.onChange]"],
                                        className: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
                                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        onChange: {
                                            "AdminUsersPage[<input>.onChange]": (e_5)=>setFormData({
                                                    "AdminUsersPage[<input>.onChange > setFormData()]": (prev_3)=>({
                                                            ...prev_3,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        onChange: {
                                            "AdminUsersPage[<input>.onChange]": (e_6)=>setFormData({
                                                    "AdminUsersPage[<input>.onChange > setFormData()]": (prev_4)=>({
                                                            ...prev_4,
        ...
        $[57] = formData.confirmPassword;
        $[58] = formData.email;
        $[59] = formData.name;
        $[60] = formData.password;
        $[61] = formData.role;
        $[62] = formData.username;
        $[63] = handleSubmit;
        $[64] = isLoading;
        $[65] = showAddModal;
        $[66] = t25;
...
_s(AdminUsersPage, "XCRYpQg1PgYhx2qlrbSGPKYWNrY=", false, function() {
    return [
...
_c = AdminUsersPage;
function _AdminUsersPageMotionDivOnClick(e_0) {
...
//# sourceMappingURL=_4c4c3924._.js.map